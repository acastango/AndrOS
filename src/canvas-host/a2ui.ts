...
export const A2UI_PATH = "/__andros__/a2ui";

export const CANVAS_HOST_PATH = "/__andros__/canvas";

export const CANVAS_WS_PATH = "/__andros__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.androsCanvasA2UIAction.postMessage(...)
  // - Android: window.androsCanvasA2UIAction.postMessage(...)
  const handlerNames = ["androsCanvasA2UIAction"];
  ...
  globalThis.androsPostMessage = postToNode;
  globalThis.androsSendUserAction = sendUserAction;
